...
int FPSCamera::FrameUpdate(float fElapsedTime)
{
	...
	{
		m_vVelocity=m_vDirection * (float)velocity_per_second *fElapsedTime;
	}
...
{
	MouseKeyCallback cb= boostl_tr1::bind(&FPSCamera::OnMouseRightDown,this,_1);
	return cb;
}
MouseKeyCallback FPSCamera::GetMouseMoveCallback()
{
	MouseKeyCallback cb= boostl_tr1::bind(&FPSCamera::OnMouseMove,this,_1);
	return cb;
}
MouseKeyCallback FPSCamera::GetMouseRightUpCallback()
{
	MouseKeyCallback cb= boostl_tr1::bind(&FPSCamera::OnMouseRightUp,this,_1);
	return cb;
}
MouseWheelCallback FPSCamera::GetMouseWheelCallback()
{
	MouseWheelCallback cb= boostl_tr1::bind(&FPSCamera::OnMouseWheel,this,_1);
	return cb;
}
KeyCallback FPSCamera::GetKeyDownCallback()
{
	KeyCallback cb= boostl_tr1::bind(&FPSCamera::OnKeyDown,this,_1);
	return cb;
}
...
void FPSCamera::SetWindow(int nWidth, int nHeigh)
{
	// do nothing
}
