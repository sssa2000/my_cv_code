...
public:
	...
	void GetWidthHeight(unsigned int& w, unsigned int&h);
	...
	void RegisterMouseMiddleDownEvent(MouseKeyCallback& e);
	void RegisterMouseMiddleUpEvent(MouseKeyCallback& e);
	...
	void RegisterChar(KeyCallback& e);
protected:
private:
	void CreateWnd();
...
private:
	...
	std::vector<MouseKeyCallback> mouse_middledown_event;
	std::vector<MouseKeyCallback> mouse_middleup_event;
	...
	std::vector<KeyCallback> keychar_event;
};