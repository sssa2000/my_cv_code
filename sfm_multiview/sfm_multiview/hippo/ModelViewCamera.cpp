...
{
	MouseKeyCallback cb= boostl_tr1::bind(&ModelViewCamera::OnMouseLeftDown,this,_1);
	return cb;
}
MouseKeyCallback ModelViewCamera::GetMouseMoveCallback()
{
	MouseKeyCallback cb= boostl_tr1::bind(&ModelViewCamera::OnMouseMove,this,_1);
	return cb;
}
MouseKeyCallback ModelViewCamera::GetMouseLeftUpCallback()
{
	MouseKeyCallback cb= boostl_tr1::bind(&ModelViewCamera::OnMouseLeftUp,this,_1);
	return cb;
}
MouseWheelCallback ModelViewCamera::GetMouseWheelCallback()
{
	MouseWheelCallback cb= boostl_tr1::bind(&ModelViewCamera::OnMouseWheel,this,_1);
	return cb;
}
KeyCallback ModelViewCamera::GetKeyDownCallback()
{
	KeyCallback cb= boostl_tr1::bind(&ModelViewCamera::OnKeyDown,this,_1);
	return cb;
}
